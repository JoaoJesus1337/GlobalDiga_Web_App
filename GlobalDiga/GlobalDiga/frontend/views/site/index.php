...
<header>
    ...
    <div class="text-center text-white">
        <img id="bannerImg" src="../img/<?= $empresa->imgBanner ?>" style="width:1300px;height:300px;border:2px solid white">
    </div>
</header>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        <a id="produtoDetails<?= $produto->id ?>" style="text-decoration: none;color:black;" href="<?= Url::toRoute(["produto/view", "id" => $produto->id]) ?>">
                            <img class="card-img-top" style="width:260px;height:220px;" src="img/<?php echo $produto->imagem ?>" alt="..." />
...
if (empty($news)) { ?>
    <section class="py-5">
        <h3 style="color:white;text-align:center">Novas Notícias</h3>
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <div class="col mb-5">
                    <div class="card h-100">
