...
<body class="d-flex flex-column h-100" style="display: flex;flex-direction:column">
    ...
    <!-- Conteudo -->
    <main role="main" class="flex-shrink-0" style="flex: 1 0 auto;background-color:#333">
...
<footer class=" text-center text-lg-start text-white" style="background-color: #222;">
    <section class="d-flex justify-content-between p-4" style="background-color: #FF7F50;">
