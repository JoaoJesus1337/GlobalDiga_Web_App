                    ...
                    <div class="d-flex">
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <form action="<?= Url::toRoute(["carrinho/create"]) ?>" method="POST">
                                ...
                                <button name="add-to-cart" class="btn btn-outline-light" type="submit">Adicionar ao Carrinho
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        ...
        if (count($relatedProducts) > 0) {  ?>
            <h2 class="fw-bolder mb-4" style="text-align: center;color:white">Produtos Relacionados</h2><br><?php } ?>
